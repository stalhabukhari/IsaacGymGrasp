...
class IsaacGymWrapper:
    ...
    def _create_sim(self):
        ...
        return (
            self.gym.create_sim(gpu_physics, gpu_render, sim_type, sim_params),
            sim_params,
        )
    ...
    def _set_transforms(self):
        ...
        self.from_trimesh_transform.r = gymapi.Quat(0, 0.7071068, 0, 0.7071068)
    ...
    def get_state(self):
        ...
        for idx, env_i in enumerate(self.envs):
            s.append(
                env_i.get_state(
                    [rb_states[idx, ...], dof_pos[idx, ...], dof_vel[idx, ...]]
                )
            )
