...
from isaacgymgrasp.utils.geometry_utils import pq_to_H
from isaacgymgrasp.utils.se3dif_utils import get_grasps_acr
from isaacgymgrasp.utils.generate_obj_urdf import generate_obj_urdf
...
class SimpleObject:
    ...
    def _set_assets(self):
        ...
        obj_asset = self.gym.load_asset(self.sim, "", asset_file_object, asset_options)
        return obj_asset
    ...
    def get_rigid_body_state(self):
        ...
        return self.gym.get_actor_rigid_body_states(
    ...
    def set_rigid_body_pos(self, pos, ori):
        ...
        obj = self.gym.get_actor_rigid_body_states(
            self.env, self.handle, gymapi.STATE_NONE
        )
        ...
        self.gym.set_actor_rigid_body_states(
            self.env, self.handle, obj, gymapi.STATE_ALL
        )
